...
6. Import the DAX measures from `docs/dax_measures.md`
7. Build the 3 report pages (Exec Summary, Drill-down, Forecast) — see `docs/case_study.md` for the narrative framing
